...
if (isset($_GET) && ! empty($_GET) && $_GET["function"] == "equipmentNameQuery") {
...
if (isset($_GET) && ! empty($_GET) && $_GET["function"] == "borrowerAEMQuery") {
...
if (isset($_GET) && ! empty($_GET) && $_GET["function"] == "borrowerNameQuery") {
        $search = filter_var($_POST['query'],FILTER_SANITIZE_STRING);
