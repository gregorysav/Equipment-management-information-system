 				...
 				<div class="container">
 					...
 					<div id="searchHolder">
	 					<div class="custom-control custom-radio">
								<input type="radio" id="totalEquipmentForUser" name="totalEquipmentForUser" value="1" class="custom-control-input" checked>
								<label class="custom-control-label" for="totalEquipmentForUser">Συνολικός</label>
								</div>
						<div class="custom-control custom-radio">
								<input type="radio" id="availableEquipmentForUser" name="availableEquipmentForUser" value="2" class="custom-control-input">
...
//  Η μεταβλητή $url έχει τεθεί από το $_SERVER['REQUEST_URI'] και ελέγχει το ακριβές url που έχει η σελίδα που βρισκόμαστε		
	    ...
	    if ($pageOfPagination > 1){    	 
	    	echo'
	    		<li class="page-item">
	    		<a href=totalEquipmentForUser.php?p='.($pageOfPagination-1).' class="page-link"><<</a></li>
	    	';
	    }

	    for ($i=1; $i <= $totalCellsPagination; $i++) { 
            if ($pageOfPagination == $i){
                echo "<li class='page-item  active'><a class='page-link' href=totalEquipmentForUser.php?p=".$i.">".$i."</a></li>";                    
            }else {

        	    echo "<li class='page-item'><a class='page-link' href=totalEquipmentForUser.php?p=".$i.">".$i."</a></li>";
            }
        }
