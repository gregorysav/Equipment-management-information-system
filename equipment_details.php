			 		...
			 		while($descriptionQuerySTMTResult=$descriptionQuerySTMT->fetch(PDO::FETCH_ASSOC)){	
					 				...
					 				<div class="row">
					 					<div class="col-md-8">
						 				  <h4>Πληροφορίες Εξαρτήματος </h4>   
										    <img class="card-img-top equipmentDetailsImage" src="uploadedImages/'.$equipQuerySTMTResult['real_filename'].'" alt="Card image cap">
										    <div class="card-body">
											    ...
											    <p class="card-text extraComment"><button tupe="submit">Προσθέστε Σχόλιο</button></p>
									    	</div>
							...
							echo '
				 			...
				 			if (isset($_POST['newComment'])){
							    ...
							    $commentQuerySTMT->bindParam(':id_equip_com', $_GET['id_equip']);
							    $commentQuerySTMT->bindParam(':id_user_com', $_SESSION['id']);
							    $commentQuerySTMT->bindParam(':comments', $_POST['newComment']);
